...
@NamedQueries({
		...
		@NamedQuery(name = JpaConst.Q_REP_GET_FOLLOW_REPORTS, query = JpaConst.Q_REP_GET_FOLLOW_REPORTS_DEF),
		@NamedQuery(name = JpaConst.Q_REP_GET_FOLLOWER_REPORTS, query = JpaConst.Q_REP_GET_FOLLOWER_REPORTS_DEF)
})
